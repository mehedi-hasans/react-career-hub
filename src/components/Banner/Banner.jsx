  ...
  return (
    <div className="text-center grid gap-5 grid-cols-1 md:grid-cols-2">
        <div className="space-y-3 text-left my-20">
          ...
          <p>Explore thousands of job opportunities which one you need with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
